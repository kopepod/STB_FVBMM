classdef BDTL
 ...
 properties(Constant = true)
  bn = cos(0:2*pi/12:2*pi-2*pi/12) + 1j * sin(0:2*pi/12:2*pi-2*pi/12);
   ...
   fields = BDTL.getRegions([32,15]);
   yx = BDTL.xytSpV(32,32,1);
 end
 ...
 methods(Static = true)
  ...
  function code = encode(v,stip)
   ...
   sv = BDTL.flipvideo(sv);
   
   sv = sv(:);
   
   codeL = mexbwd(sv,scan{1},scan{2});
   codeH = mexbwd(sv,scan{3},scan{4});
  ...
  function code = binTraj(x,y)
   ...
   for k = 1:numel(s)
    ...
    if s(k) > 0.2 && s(k) < 0.8
     [~,idx] = min(bsxfun(@minus,u(k),BDTL.bn));
     code{k} = BDTL.bs{idx};
     continue
    end
  ...
  function regions = getRegions(st)
   ...
   Y = BDTL.splitInt(size(v,1),4);
   X = BDTL.splitInt(size(v,2),4);
   T = BDTL.splitInt(size(v,3),2);
   
   v = mat2cell(v,Y,X,T);
   
   v = BDTL.fillvolumeidx(v);
   ...
   regions = {cell2mat(scanL(1,:)),cell2mat(scanL(2,:)),cell2mat(scanH(1,:)),cell2mat(scanH(2,:))};
  ...
  function field = pttnfield()
   ...
   field(33,:) = {[2;3;6;7],[10;11;14;15]};
   field(34,:) = {[5;6;9;10],[7;8;11;12]};
   field(35,:) = {[2;3;14;15],[6;7;10;11]};
   field(36,:) = {[5;8;9;12],[6;7;10;11]};
   
   field(37,:) = {[1;4;13;16],[6;7;10;11]};
   field(38,:) = {[2;3;6;7],[9;12;13;16]};
   field(39,:) = {[3;4;15;16],[5;6;9;10]};
   field(40,:) = {[1;2;3;4],[13;14;15;16]};
   field(41,:) = {[1;5;9;13],[4;8;12;16]};
   
   
   field(42,:) = {[1;5;12;16],[4;8;9;13]};
   field(43,:) = {[1;2;15;16],[3;4;13;14]};
